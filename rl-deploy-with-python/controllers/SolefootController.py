...
class SolefootController:
    def __init__(self, model_dir, robot, robot_type, rl_type, start_controller):
        ...
        self.model_policy = f'{model_dir}/{self.robot_type}/policy/{self.rl_type}/policyv5.onnx'
        self.model_encoder = f'{model_dir}/{self.robot_type}/policy/{self.rl_type}/encoderv5.onnx'
