...
class PointfootController:
    def __init__(self, model_dir, robot, robot_type, rl_type, start_controller):
        ...
        self.model_policy = f'{model_dir}/{self.robot_type}/policy/{self.rl_type}/policy_ver0.onnx'
        self.model_encoder = f'{model_dir}/{self.robot_type}/policy/{self.rl_type}/encoder_ver0.onnx'
